      ...
      <div style={{ maxWidth: 960, margin: "0 auto", padding: "32px 20px" }}>
        ...
        {step === "error" && (
          <div style={{ maxWidth: 480, margin: "60px auto", textAlign: "center" }}>
            ...
            <h2 style={{ fontSize: 20, fontWeight: 700, color: "#0f172a", marginBottom: 8 }}>Error al generar la evaluación</h2>
            <p style={{ fontSize: 14, color: "#dc2626", marginBottom: 24, lineHeight: 1.6 }}>{error}</p>
            <Btn onClick={handleReset} primary>← Volver al formulario</Btn>
          </div>
        )}
